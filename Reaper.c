...
info = """\033[91m
╔══════════════════════════════════════════════════════╗
║                     \033[00mReaper Info\033[91m                      ║
║══════════════════════════════════════════════════════║
║ \033[00m[+] Reaper Was Made By Zinqo.\033[91m                        ║
...
║══════════════════════════════════════════════════════║
║ \033[00mMethods \033[91m|\033[00m Shows DDOS Methods For Reaper.\033[91m             ║
║ \033[00mExtras  \033[91m|\033[00m Shows Extra Commands For Reaper.\033[91m           ║
║ \033[00mUpdates \033[91m|\033[00m Shows Update Notes For Reaper.\033[91m             ║
║ \033[00mInfo    \033[91m|\033[00m Shows Reaper Info.\033[91m                         ║
║ \033[00mClear   \033[91m|\033[00m Clears Screen.\033[91m                             ║
║ \033[00mExit    \033[91m|\033[00m Exits Out Of Reaper.\033[91m                       ║
╚══════════════════════════════════════════════════════╝\033[00m
"""
...
def main():
	...
	while True:
		sys.stdout.write("\x1b]2;Reaper\x07")
		...
		if sinput == "clear":
			...
			print ("[\033[91mReaper\033[00m] You Are Exiting Out Of Reaper.\n")
			exit()
		elif sinput == "methods":
			print (methods)
			main()
			...
			print ("[\033[91mReaper\033[00m] Total Attacks Running: {}\n".format (aid))
			main()
		elif sinput == "resolve":
			liips += 1
			host = sin.split(" ")[1]
